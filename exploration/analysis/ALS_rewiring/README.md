...
Outputs follow the `als_rewiring_*` paths. The full matrix has about
93 million rows (~16 GB).
...
This exports direct GO-to-gene annotations.
...
`MUT1_D22_Cytoplasmic_VCP-R155C`. Retain biological replicates: this analysis averages
